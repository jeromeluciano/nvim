...
Group.new("@rapper_argument", c.red:light(), nil, s.italic)
Group.new("@rapper_return", c.orange:light(), nil, s.italic)
Group.new("@lsp.type.property.lua", c.red, nil, s.none)
-- C 
Group.new("@lsp.type.variable", c.red, nil, s.none)
Group.new("@lsp.type.parameter", c.red, nil, s.none)
Group.new("@parameter", c.red, nil, s.none)
-- lua
Group.new("@lsp.type.property.lua", c.superwhite, nil, s.none)
Group.new("@lsp.type.function.lua", c.blue, nil, s.none)
Group.new("@lsp.type.method.lua", c.blue, nil, s.none)
Group.new("luafunctioncall", c.blue)
-- global
Group.new("@lsp.type.method", c.blue, nil, s.none)
Group.new("@function.builtin", c.blue, nil, s.none)
Group.new("@punctuation.bracket", c.blue, nil, s.none)

Group.new("@parameter.c", c.red, nil, s.none)

Group.new("@lsp.type.parameter.c", c.red, nil, s.none)

Group.new("@punctuation.bracket.c", c.violet, nil, s.none)
Group.new("@type.builtin.c", c.violet, nil, s.none)

Group.new("@constructor.ocaml", c.orange:light(), nil, s.none)
Group.new("@field.value", c.orange:light(), nil, s.none)
Group.new("@field.lua", c.orange:light(), nil, s.none)
Group.new("@function.builtin.lua", c.orange:light(), nil, s.none)
Group.new("constant", c.orange:light(), nil, s.none)
